        ...
        <div className='grid grid-cols-2 gap-7'>
            <div className='offer-box flex items-center border-[1px] gap-10 rounded-lg border-[#273b71] py-9 px-11'>
                ...
                <div className='w-[70%]'>
                    ...
                    <p className='text-light text-xl text-ellipsis line-clamp-3'>Regularly organized survival game tournaments for games like
            ...
            <div className='offer-box flex items-center border-[1px] gap-10 rounded-lg border-[#273b71] py-9 px-11'>
                ...
                <div className='w-[70%]'>
                    ...
                    <p className='text-light text-xl text-ellipsis line-clamp-3'>A simple and fair token system for accessing
            ...
            <div className='offer-box flex items-center border-[1px] gap-10 rounded-lg border-[#273b71] py-9 px-11'>
                <div className=' yellow-ico h-16 w-16 rounded-full relative text-white flex items-center justify-center'><FaEye className='text-5xl'/></div>
                <div className='w-[70%]'>
                    <h3 className='text-3xl text-white font-bold mb-3'>Morpheous Vision
                    </h3>
                    <p className='text-light text-xl text-ellipsis line-clamp-3'>At Morpheous Gaming, we envision a united family of players growing together, excelling, and seizing opportunities to shine on bigger platforms.</p>
                </div>
