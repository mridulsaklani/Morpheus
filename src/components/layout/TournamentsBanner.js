...
const TournamentsBanner = () => {
  ...
  return (
    <>
      <div className=" tour-banner relative pt-56 pb-32">
      <div className="banner-overlay absolute top-0 left-0 w-full h-full"></div>
      <div className="flex max-w-7xl mx-auto relative z-20">
        <div className='w-1/2'>
        <h1 className='text-5xl font-bold text-white leading-tight mb-4'>Step Into the Spotlight: Tournament Time!</h1>
