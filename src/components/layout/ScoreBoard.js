        ...
        <div className="max-w-7xl mx-auto">
          <div className="w-full flex flex-col items-center justify-center gap-5 pb-10">
            ...
            <p className="text-2xl text-center w-2/3 font-light">
              This Month’s Heroes, Next Month Could Be Yours—Seize Your
              Victory!
            </p>
          </div>
          <div className="w-full flex justify-center items-center flex-col gap-10">
            ...
            {HeaderShow === 1 && (
              <table className="table-1 min-w-full table-auto border-collapse border-[1px] border-[#ffffff17] text-sm shadow-xl">
                <thead>
                ...
                <tbody>
                  {Array.from({ length: 10 }).map((_, index) => (
                    ...
                    >
                      <td className="px-4 py-4 border-b-[1px] border-[#ffffff17] flex items-center space-x-3 text-lg font-medium">
                        <Image
                          src={`/user.png`}
                          width={32}
                          height={32}
                      ...
                      <td className="px-4 py-4 border-b-[1px] border-[#ffffff17] text-lg font-medium text-[#F0AD4E]">
                        4000Rs
                      </td>
